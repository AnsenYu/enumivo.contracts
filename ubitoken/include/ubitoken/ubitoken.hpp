...
namespace enumivo {
   ...
   class [[enumivo::contract("ubitoken")]] ubitoken : public contract {
      public:
         ...
         static const uint64_t issue_wait_time  = (uint64_t)1000000 * 3600 * 24; // wait 1 day to issue
         static const uint64_t disconnect_wait_time = (uint64_t)1000000 * 3600 * 24 * 30; // wait 30 days to due
